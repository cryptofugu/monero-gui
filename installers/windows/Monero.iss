...
; Copyright (c) 2020 Blockchain Solutions
; See LICENSE
#define GuiVersion GetFileVersion("bin\monero-wallet-gui.exe")

[Setup]
AppName=MoneroBS GUI Wallet
...
DefaultDirName={commonpf}\MoneroBS GUI Wallet
DefaultGroupName=MoneroBS GUI Wallet
UninstallDisplayIcon={app}\monerobs-wallet-gui.exe
...
LicenseFile=LICENSE
AppPublisher=Blockchain Solutions
AppPublisherURL=https://cryptofugu.com
TimeStampsInUTC=yes
...
Source: "bin\monerobs-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\monerobs-gui-wallet-guide.pdf"; DestDir: "{app}"; Flags: ignoreversion

; Monero CLI wallet
Source: "bin\extras\monerobs-wallet-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion

; Monero wallet RPC interface implementation
Source: "bin\extras\monerobs-wallet-rpc.exe"; DestDir: "{app}"; Flags: ignoreversion

; Monero daemon
Source: "bin\monerobsd.exe"; DestDir: "{app}"; Flags: ignoreversion

; Monero daemon wrapped in a batch file that stops before the text window closes, to see any error messages
Source: "monerobs-daemon.bat"; DestDir: "{app}"; Flags: ignoreversion;

; Monero blockchain utilities
Source: "bin\extras\monerobs-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\monerobs-gen-ssl-cert.exe"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  ...
  blockChainDefaultDir := ExpandConstant('{commonappdata}\monerobs');
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\BS\monerobs-core', 'blockchainDataDir', blockChainDir);
...
begin
  Result := BlockChainDir('') + '\monerobs.log';
...
begin
  if CurStep = ssPostInstall then begin
    ...
    s[1] := '"' + ExpandConstant('{app}\monerobsd.exe') + '" ' + DaemonFlags('');
    s[2] := 'PAUSE';
    SaveStringsToFile(ExpandConstant('{app}\monerobs-daemon.bat'), s, false); 
  end;
end;
...
Name: "{group}\GUI Wallet"; Filename: "{app}\monerobs-wallet-gui.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\monerobs-gui-wallet-guide.pdf"; IconFilename: "{app}\monerobs-wallet-gui.exe"
...
Name: "{group}\Utilities\MoneroBS Daemon"; Filename: "{app}\monerobsd.exe"; Parameters: {code:DaemonFlags}
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\monerobs-wallet-cli.exe"; WorkingDir: "{userdocs}\MoneroBS\wallets"
...
Name: "{group}\Utilities\x (Check Default Wallet Folder)"; Filename: "{win}\Explorer.exe"; Parameters: """{userdocs}\MoneroBS\wallets"""
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: """{userappdata}\monerobs-wallet-gui\monerobs-wallet-gui.log"""
Name: "{group}\Utilities\x (Try Daemon, Exit Confirm)"; Filename: "{app}\monerobs-daemon.bat"
Name: "{group}\Utilities\x (Try GUI Wallet Low Graphics Mode)"; Filename: "{app}\start-low-graphics-mode.bat"
Name: "{group}\Utilities\x (Try Kill Daemon)"; Filename: "Taskkill.exe"; Parameters: "/IM monerobsd.exe /T /F"

; Desktop icons, optional with the help of the "Task" section
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\monerobs-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\BS"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\BS\monerobs-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\BS\monerobs-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};
...
Root: HKCR; Subkey: "monerobs"; ValueType: "string"; ValueData: "URL:MoneroBS Payment Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "monerobs"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "monero\DefaultIcon"; ValueType: "string"; ValueData: "{app}\monerobs-wallet-gui.exe,0"
Root: HKCR; Subkey: "monero\shell\open\command"; ValueType: "string"; ValueData: """{app}\monerobs-wallet-gui.exe"" ""%1"""
...
Root: HKCR; Subkey: "monerobsseed"; ValueType: "string"; ValueData: "URL:Monero Seed Node Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "monerobsseed"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "moneroseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\monerobs-wallet-gui.exe,0"
Root: HKCR; Subkey: "moneroseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\monerobs-wallet-gui.exe"" ""%1"""
