#!/bin/bash
MONERO_URL=https://github.com/cryptofugu/monero.git
MONERO_BRANCH=fork
...
git -C $MONERO_DIR checkout v0.16.0.0f2
...
git -C $MONERO_DIR config user.name "MoneroBS GUI"
git -C $MONERO_DIR config user.email "gui@monerobs.local"
